...
var myWorkDayChart = echarts.init(document.getElementById("workday_chart"));

showWorkDayChart()

function showWorkDayChart(){
    chart_kind = 'workday'
	getData(chart_kind);
	var option = getWorkDayOption()
	myWorkDayChart.setOption(option);
}
